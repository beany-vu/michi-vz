export const charts = [
  ...
  },
  {
    ...
    use: "Correlation between two metrics, with an optional third encoded as bubble size.",
  },
  {
    name: "Radar Chart",
    path: "charts-radar-chart",
    use: "Profile comparison of a few entities across many shared metrics.",
  },
  {
    name: "Gap Chart",
  ...
  },
  {
    ...
    path: "charts-vertical-stack-bar-chart",
    use: "Composition across discrete categories or periods, with optional side-by-side groups.",
  },
  {
